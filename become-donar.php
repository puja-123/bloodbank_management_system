...
// $picProfile = $_FILES['image']['name'];
// $tmp_dir = $_FILES['image']['temp_name'];
// $imageSize = $_FILES['image']['size'];

// $upload_dir = 'uploads/';

// $imgExt = strtolower(pathinfo($picProfile,PATHINFO_EXTENSION));
// $valid_extensions= array('jpeg','png','jpg','pdf');
// $image = rand(1000,1000000).".".$imgExt;
// move_uploaded_file($tmp_dir,$upload_dir.$image);
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Gender,Age,BloodGroup,Address,Message,status) VALUES(:fullname,:mobile,:email,:gender,:age,:blodgroup,:address,:message,:status)";
...
<!-- <label style='color:blue;'>Upload Image
